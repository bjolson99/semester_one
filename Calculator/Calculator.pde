...
void setup() {
  ...
  opButtons[0] = new CalcButton(345, 165).asOperator("+", 45, 45);
  opButtons[1] = new CalcButton(10, 55).asOperator("C", 45, 45);
  opButtons[2] = new CalcButton(345, 225).asOperator("=", 45, 100);
  opButtons[3] = new CalcButton(345, 55).asOperator("*", 45, 45);
  opButtons[4] = new CalcButton(345, 110).asOperator("-", 45, 45);
